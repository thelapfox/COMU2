...
# Author: Murillo_Nicolas_Moncada_William
# Copyright: UIS
# Description: Modulacion ASK en gnuradio
...
class Practica2_labcomu2_BH1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica2_labcomu2_BH1")
        ...
        self.ka = ka = 1
        self.interpolacion = interpolacion = 10
        self.fc = fc = 50e6
        self.GTX = GTX = 0
        self.GRX = GRX = 0
        self.DC = DC = 0
        ...
        self._interpolacion_range = Range(0, 100, 1, 10, 200)
        self._interpolacion_win = RangeWidget(self._interpolacion_range, self.set_interpolacion, "interpolacion", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._interpolacion_win)
        ...
        self._DC_range = Range(-2, 2, 0.1, 0, 200)
        ...
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, interpolacion)
        ...
        self._GRX_range = Range(0, 31, 0.5, 0, 200)
    ...
    def set_interpolacion(self, interpolacion):
        self.interpolacion = interpolacion
        self.blocks_repeat_0.set_interpolation(self.interpolacion)
...
def main(top_block_cls=Practica2_labcomu2_BH1, options=None):
